...
extern void Test_sha256 (CuTest*);
extern void Test_entropy (CuTest*);
extern void Test_file_dequote (CuTest*);
extern void Test_ignore_ok (CuTest*);
extern void Test_inotify(CuTest*);
...
int RunAllTests(void) 
{
    ...
    SUITE_ADD_TEST(suite, Test_ignore_ok );
    SUITE_ADD_TEST(suite, Test_inotify);
